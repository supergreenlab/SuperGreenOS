...
void preinit_kv() {
  ...
  const char *default_mdns_domain = "solo";
  ...
  const char *default_ota_basedir = "/SoloPreRelease";
  ...
  int default_box_0_blower_gpio = 22;
  ...
  int default_box_1_blower_gpio = 21;
  ...
  int default_box_2_blower_gpio = 20;
