...
enum idx
{
   ...
   */
    ...
    CHAR_VAL_CFG(STARTED_AT),
    CHAR_VAL(ON_HOUR),
    CHAR_VAL(ON_MIN),
    CHAR_VAL(OFF_HOUR),
    CHAR_VAL(OFF_MIN),
    CHAR_VAL_CFG(STRETCH),
    CHAR_VAL_CFG(LED_DIM),
    CHAR_VAL_CFG(BLOWER),
    CHAR_VAL_CFG(SHT1X_TEMP_C),
    CHAR_VAL_CFG(SHT1X_TEMP_F),
    CHAR_VAL_CFG(SHT1X_HUMI),
    CHAR_VAL_CFG(LED_INFO),
    CHAR_VAL_CFG(LED_0_DUTY),
    CHAR_VAL_CFG(LED_1_DUTY),
    CHAR_VAL_CFG(LED_2_DUTY),
    CHAR_VAL_CFG(LED_3_DUTY),
    CHAR_VAL_CFG(LED_4_DUTY),
    CHAR_VAL_CFG(LED_5_DUTY),
  /*
   * [/GENERATED]
   */
  HRS_IDX_NB,
